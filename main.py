...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: white; font-wheight: 700;'
        )
        ...
        self.add_btn(QPushButton(
            '<-'), 2, 4, 1, 1, lambda: self.display.setText(
                self.display.text()[:-1]),
            'background: #13822a; color: white; font-wheight: 700;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_iqual,
            'background: #095177; color: white; font-wheight: 700;'
        )
